...
You can install the SDK [manually][1] or via `CocoaPods`. The latter option is highly recommended.
...
Go to [Quick Starts - Facebook for Developers][2] to create an app. 
...
=> [How to get bundle identifier][4]
...
b. 
  ...
  [1]: https://developers.facebook.com/docs/ios/getting-started#download
  [2]: https://developers.facebook.com/quickstarts/?platform=ios
  [3]: http://i.stack.imgur.com/Ysye4.png
  [4]: http://stackoverflow.com/a/33377536/938380
