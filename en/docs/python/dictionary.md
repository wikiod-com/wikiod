...
A dictionary is an example of a _key value store_ also known as _Mapping_ in Python. It allows you to store and retrieve elements by referencing a key.  As dictionaries are referenced by key, they have very fast lookups. As they are primarily used for referencing items by key, they are not sorted.
...
[1]: https://www.wikiod.com/python/list-comprehensions
