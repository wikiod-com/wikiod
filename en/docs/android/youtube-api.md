...
2. You need to include this jar in your project. Copy and paste this jar in libs folder and don't forget to add it in gradle file
    dependencies {
...
First you need to get an SHA-1 fingerprint for your machine. There are various methods for retrieving it. You can choose any method provided in [this Q&A][1].

**Google API console and YouTube key for Android**

Now that you have an SHA-1 fingerprint, open the Google API console and create a project. Go to [this page][2] and create a project using that SHA-1 key and enable the YouTube Data API. Now you will get a key. This key will be used to send requests from Android and fetch data.
...
Below it is shown how the _gradle.build_ would finally look like.
...
Now I want to show how to get playlists via the YouTube API by providing the playlist IDs. For this task I will use `AsyncTask`. To understand how we request parameters and to understand the flow, please take a look at the [YouTube Data API][3].
...
Finally, in our `MainActivity` we will have to do the following:
  ...
  [1]: http://stackoverflow.com/q/27609442/5275639
  [2]: https://console.developers.google.com/iam-admin/projects?authuser=1
  [3]: https://developers.google.com/youtube/v3/docs/playlists/list
