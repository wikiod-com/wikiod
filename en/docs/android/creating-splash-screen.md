---
title: "Creating Splash screen"
slug: "creating-splash-screen"
draft: false
images: []
weight: 9947
type: docs
...
Create a new directory named _anim_ in the _res_ directory. Right-click it and create a new _Animation Resource_ file named _fade_in.xml_:

[![Directory structure containing new Animation Resource file][1]][1]

Then, put the following code into the _fade_in.xml_ file:
...
Turn your `Splash` activity into a launcher by adding the following code to the _AndroidManifest_ file:
...
Then, remove the default launcher activity by removing the following code from the *AndroidManifest* file:
  ...
  [1]: https://i.stack.imgur.com/M2lkT.png
