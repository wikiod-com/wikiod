...
[![enter image description here][1]][1]
  ...
  [1]: http://i.stack.imgur.com/XrJ3N.gif

## Show and Hide FloatingActionButton on Scroll
Starting with the Support Library version 22.2.1, it's possible to show and hide a [FloatingActionButton][1] from scrolling behavior using a [`FloatingActionButton.Behavior`][2] sublclass that takes advantage of the [`show()`][3] and [`hide()`][4] methods.

Note that this only works with a [CoordinatorLayout][5] in conjunction with inner Views that support Nested Scrolling, such as [RecyclerView][6] and [NestedScrollView][7].

This `ScrollAwareFABBehavior` class comes from the [Android Guides on Codepath][8] <sub><sup>(cc-wiki with attribution required)</sup></sub>
...
[![enter image description here][9]][9]
  ...
  [1]: https://developer.android.com/reference/android/support/design/widget/FloatingActionButton.html
  [2]: https://developer.android.com/reference/android/support/design/widget/FloatingActionButton.Behavior.html
  [3]: https://developer.android.com/reference/android/support/design/widget/FloatingActionButton.html#show()
  [4]: https://developer.android.com/reference/android/support/design/widget/FloatingActionButton.html#hide()
  [5]: https://developer.android.com/reference/android/support/design/widget/CoordinatorLayout.html
  [6]: https://developer.android.com/reference/android/support/v7/widget/RecyclerView.html
  [7]: https://developer.android.com/reference/android/support/v4/widget/NestedScrollView.html
  [8]: https://github.com/codepath/android_guides/wiki/Floating-Action-Buttons
  [9]: http://i.stack.imgur.com/ijLDS.gif
...
If you only want to change only the Interior icon use a 24 x 24dp icon for default size
  ...
  [1]: http://i.stack.imgur.com/k84iu.png
  [2]: https://i.stack.imgur.com/M3R1u.png
