---
title: "Spring Boot + Spring Data Elasticsearch"
slug: "spring-boot-+-spring-data-elasticsearch"
draft: false
images: []
weight: 9992
type: docs
...
[Spring Data Elasticsearch][1] is a [Spring Data][2] implementation for [Elasticsearch][3] which provides integration with the [Elasticsearch][3] search engine.
...
We will use [Spring Boot][1] of version `1.5.6.RELEASE` and [Spring Data Elasticsearch][2] of that respective version. For this project, we need to run [elasticsearch-2.4.5][3] to test our apis. 
...
**Official Documentations:**
 ...
 - https://projects.spring.io/spring-data-elasticsearch/
  ...
  [1]: https://mvnrepository.com/artifact/org.springframework.boot/spring-boot-starter/1.5.6.RELEASE
  [2]: https://github.com/spring-projects/spring-data-elasticsearch
  [3]: https://www.elastic.co/downloads/past-releases/elasticsearch-2-4-5
