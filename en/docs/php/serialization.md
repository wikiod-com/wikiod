...
| Parameter | Details | 
|-----------|---------|
| value | The value to be serialized. [serialize()][1] handles all types, except the [resource][2]-type. You can even serialize() arrays that contain references to itself. Circular references inside the array/object you are serializing will also be stored. Any other reference will be lost. When serializing objects, PHP will attempt to call the member function [__sleep()][3] prior to serialization. This is to allow the object to do any last minute clean-up, etc. prior to being serialized. Likewise, when the object is restored using [unserialize()][4] the [__wakeup()][5] member function is called. Object's private members have the class name prepended to the member name; protected members have a '*' prepended to the member name. These prepended values have null bytes on either side.
|


  [1]: http://php.net/manual/en/function.serialize.php
  [2]: http://php.net/manual/en/language.types.resource.php
  [3]: http://php.net/manual/en/language.oop5.magic.php#object.sleep
  [4]: http://php.net/manual/en/function.unserialize.php
  [5]: http://php.net/manual/en/language.oop5.magic.php#object.wakeup
