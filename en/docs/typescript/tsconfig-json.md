...
Not enough? If you are a hard coder and want more, then you may be interested to check your TypeScript files with tslint before compiling it with tsc. Check how to [configure tslint for even stricter code][1].


  [1]: https://www.wikiod.com/typescript/tslint---assuring-code-quality-and-consistency#Configuration for fewer programming errors
