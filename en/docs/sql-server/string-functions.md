...
* [Unicode](https://www.wikiod.com/sql-server/string-functions#Unicode)
...
## String_Split
<!-- if version [gte SQL Server 2016] -->
...
See also [Date & Time Formatting using FORMAT][4] documentation example.
