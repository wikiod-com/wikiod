...
# 2009 #
 ...
 - 1st October : [First very early preview of npm, the Node package   
   manager](https://groups.google.com/forum/?hl=en#!topic/nodejs/erDWyS4xPw8)
 - 8th November : [Ryan Dahl's (Creator of Node.js) Original
   Node.js Talk    at JSConf 2009](https://www.youtube.com/watch?v=ztspvPYybIY)
...
- 10th July : [The Node Beginner Book, an introduction to Node.js, is completed](http://nodebeginner.org/index.html).
     - A comprehensive Node.js tutorial for beginners.
- 16th August : [LinkedIn uses Node.js](http://venturebeat.com/2011/08/16/linkedin-node/)
     - LinkedIn launched its completely overhauled mobile app with new features and new parts under the hood.
- 5th October : [Ryan Dahl talks about the history of Node.js and why he created it](https://www.youtube.com/watch?v=SAc0vQCC6UQ)
- 5th December : [Node.js in production at Uber](https://www.joyent.com/developers/videos/node-js-office-hours-curtis-chambers-uber)
...
- 22nd November : [Node.js Memory Leak at Walmart](http://www.joyent.com/blog/walmart-node-js-memory-leak)
...
- 23rd October : [Node.js Advisory Board](https://www.joyent.com/blog/node-js-advisory-board)
...
- 19th November : [Node.js in Flame Graphs - Netflix](http://techblog.netflix.com/2014/11/nodejs-in-flames.html)
- 28th November : [IO.js](https://iojs.org/) – Evented I/O for V8 Javascript
...
- 10th Febraury : [Joyent Moves to Establish Node.js Foundation](http://www.joyent.com/about/press/joyent-moves-to-establish-nodejs-foundation)
...
- 27th Febraury : [IO.js and Node.js reconciliation proposal](https://github.com/nodejs/node/issues/978)
...
- 2nd August : [Trace - Node.js performance monitoring and debugging](http://trace.risingstack.com/)
    - Trace is a visualized microservice monitoring tool that gets you all the metrics you need when operating microservices.
- 13th August : [4.0 is the new 1.0](https://medium.com/node-js-javascript/4-0-is-the-new-1-0-386597a3436d#.pjnzem4ar)
...
- 8th & 9th December : [Node Interactive](http://events.linuxfoundation.org/events/node-interactive/program/schedule)
